...
import com.surya.onspot.qrscanFragments.FragmentShipmentCompleted;
import com.surya.onspot.qrscanFragments.FragmentShipmentPending;
...
public class FragmentShipmentHistoryBase extends Fragment {
    ...
    public void onResume() {
        ...
        ((HomeScreen) getActivity()).getSupportActionBar().setTitle(resources.getString(R.string.shipment_history_page_title));
    ...
    public void refreshTabs() {
        ...
        for (int index = 0; index < mTabsLinearLayout.getChildCount(); index++) {
            if (mTabsLinearLayout != null) {
                ...
                tv.setText(resources.getStringArray(R.array.shipment_tabs)[index].toUpperCase(l));
            }
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_shipment_history_base, container, false);
    }
...
//		Typeface custom_font = Typeface.createFromAsset(getActivity().getAssets(), "fonts/MyriadPro-Regular.otf");
        ...
        tabs.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(final int position) {
                ...
                switch (position) {
                    case 0:
                        FragmentShipmentCompleted fragmentCompleted = (FragmentShipmentCompleted) adapter.instantiateItem(mViewPager, 0);
                        if (fragmentCompleted != null) {
                            fragmentCompleted.fragmentBecameVisible();
                        }
                        break;
                    case 1:
                        FragmentShipmentPending fragmentPending = (FragmentShipmentPending) adapter.instantiateItem(mViewPager, 1);
    ...
    public class SectionsPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    fragment = new FragmentShipmentCompleted();
                    return fragment;
                case 1:
                    fragment = new FragmentShipmentPending();
                    return fragment;
            }
            return null;
        }
