 ...
 */
public class FragmentShipmentPending extends Fragment {
    ...
    public FragmentShipmentPending() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainView = inflater.inflate(R.layout.fragment_shipment_pending, container, false);
        initView();
        return mainView;
    }

    private void initView() {
        listView = mainView.findViewById(R.id.listView_pending);
    ...
    private void getCompletedListFromServer() {
        ...
        ServiceCalls objServiceCall = new ServiceCalls(getActivity(), (Utils.getPreference(getContext(), PreferenceKeys.MODULE_TYPE, "fans").equalsIgnoreCase("fans") ? API_CONSTANTS.API_BASE : API_CONSTANTS.API_BASE_APPLIANCE1) + API_CONSTANTS.API_SHIPMENT_HISTORY,
...
//        getCompletedListFromServer();
    ...
    public class RowReceivedHistoryCompletedAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.row_search_history_item, null);
    ...
    class CompletedListModel {
        ...
        public CompletedListModel(String id, String quantity, String rec_quantity, String completed, String created_at, String PO_number, String PO_date, String invoice_number, String invoice_date, String client) {
            this.id = id;
