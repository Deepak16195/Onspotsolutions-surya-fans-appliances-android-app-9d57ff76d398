...
public class LicenceFragment extends Fragment implements OnClickListener {
    Context cntx;
    ...
    public void onResume() {
        ...
        ((HomeScreen) getActivity()).getSupportActionBar().setTitle(resources.getString(R.string.Licenses));
...
//        progressBar = ProgressDialog.show(cntx, "", "Loading...");
        ...
        if (Utils.getPreference(cntx, PreferenceKeys.KEY_LANGUAGE, "en").equals("en")) {
            objWebView.loadUrl(API_CONSTANTS.URL_LICENSE_EN);
        } else {
            objWebView.loadUrl(API_CONSTANTS.URL_LICENSE_HI);
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.page_licence, container, false);
        cntx = getActivity();
        initViews();
        return view;
    }
...
//		mlayout.setOnClickListener(this);
        ...
        LinearLayout linearLayoutEnglishContent = view.findViewById(R.id.linearLayout_english_content);
        TextView textViewHindiContent = view.findViewById(R.id.textView_hindi_content);

        if (Utils.getPreference(cntx, PreferenceKeys.KEY_LANGUAGE, "").equals("hi")) {
            linearLayoutEnglishContent.setVisibility(LinearLayout.GONE);
            textViewHindiContent.setVisibility(TextView.VISIBLE);
        } else {
            linearLayoutEnglishContent.setVisibility(LinearLayout.VISIBLE);
            textViewHindiContent.setVisibility(TextView.GONE);
        }
    }
