...
public class FaqFragment extends Fragment implements OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.page_unkown, container, false);
        cntx = getActivity();
    ...
    public void onResume() {
        ...
        ((HomeScreen) getActivity()).getSupportActionBar().setTitle(resources.getString(R.string.faq_title));
        ((TextView) view.findViewById(R.id.textView_faq)).setText(resources.getString(R.string.faq));
...
//        progressBar = ProgressDialog.show(cntx, "", "Loading...");
        ...
        if (Utils.getPreference(cntx, PreferenceKeys.KEY_LANGUAGE, "en").equals("en")) {
            objWebView.loadUrl(API_CONSTANTS.URL_FAQ_EN);
        } else {
            objWebView.loadUrl(API_CONSTANTS.URL_FAQ_HI);
        }
    }
