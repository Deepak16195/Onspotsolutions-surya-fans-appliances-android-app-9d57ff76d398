...
public class NewShipmentScannerActivity extends AppCompatActivity implements DecoratedBarcodeView.TorchListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        activity = NewShipmentScannerActivity.this;
        ...
        numberOfCartons = newShipmentDetailModelArrayList.size();
                ...
                if (result.getText() == null) {
                    ...
                    if (isBarcodeExistsInSystem(result.getText())) {
                        if (!isBarcodeExists(result.getText())) {
                            ...
                            if (SacnnedBarcodeList.size() <= numberOfCartons) {
                                SacnnedBarcodeList.add(result.getText());
                                objDatabaseHelper.updateShipment(result.getText(), "0");

                                if (SacnnedBarcodeList.size() == numberOfCartons) {
                                    Utils.out("BARCODE : CARTONS SCANNED : " + SacnnedBarcodeList);
                                    Utils.out("BARCODE : CARTONS SCANNED : " + BarcodeList);
                                    capture.onPause();
                                ...
                                },"Max scan carton limit reached.","Alert!!");
                            }
                        } else {
                            ...
                            },"Barcode already scanned. Please try different barcode. ","Alert!!");
                        ...
                        },"Barcode does not exists in system.","Alert");
                    }
                }
