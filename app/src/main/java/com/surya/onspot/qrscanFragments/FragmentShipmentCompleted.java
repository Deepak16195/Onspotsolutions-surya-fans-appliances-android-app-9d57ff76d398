...
public class FragmentShipmentCompleted extends Fragment {
    ...
    public FragmentShipmentCompleted() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mainView = inflater.inflate(R.layout.fragment_shipment_completed, container, false);
        initView();
        return mainView;
    }
...
//        getCompletedListFromServer();
    ...
    private void showNetworkFailDialog(String msg) {
        ...
        tvMsg.setText(msg);
        content.findViewById(R.id.btnNetworkFailureOK).setOnClickListener(new View.OnClickListener() {
            @Override
